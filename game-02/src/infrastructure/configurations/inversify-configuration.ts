...
import { AgedBrieItemStrategy } from 'src/application/strategies/aged-brie-item-strategy';
import { BackstagePassItemStrategy } from 'src/application/strategies/backstage-pass-item-strategy';
import { SulfurasItemStrategy } from 'src/application/strategies/sulfuras-item-strategy';
import { ConjuredItemStrategy } from 'src/application/strategies/conjured-item-strategy';
import { NormalItemStrategy } from 'src/application/strategies/normal-item-strategy';
...
import { UpdateItemQualityService } from 'src/application/services/update-item-quality-service';
